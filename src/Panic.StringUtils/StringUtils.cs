...
namespace Panic.StringUtils
{
    public static class StringUtils
    {
        ...
        private static Regex reIndent = new Regex(@"^[ \t]*(?=\S)", RegexOptions.Multiline);
        ...
        {
            int indent = reIndent.Matches(str).Cast<Match>().Select(m => m.Value.Length).Min();
        ...
        {
            return ChangeCaseFirst(str, c => c.ToUpperInvariant());
        }
        ...
        {
            return ChangeCaseFirst(str, c => c.ToLowerInvariant());
        }
        ...
        {
            return ToUpperFirst(str.ToLowerInvariant());
        }
        ...
        {
            return ChangeCase(str, " ", (word) => word.ToUpperInvariant());
        }
        ...
        {
            return ChangeCase(str, " ", word => word.ToLowerInvariant());
        }
        ...
        {
            return ChangeCase(str, "_", word => word.ToLowerInvariant());
        }

        public static string ChangeCase(string str, Func<string, string> composer)
        {
            return ChangeCase(str, "", composer);
        }
        ...
        public static string ChangeCase(string str, Func<string, int, string> composer)
        {
            return ChangeCase(str, "", composer);
        }
        ...
        private static string ChangeCaseFirst(string str, Func<string, string> change)
        {
            return change(str.Substring(0, 1)) + str.Substring(1);
        }
    }
}
